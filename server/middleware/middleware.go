...
// GetAllCase for get all the cases route
...
// GetAllOfficer for get all the officers route
...
// CreateCase for create case route
...
// CreateOfficer for create officer route
...
// CaseComplete for updating case status
...
func getFreeOfficer() models.PoliceOfficer {
	...
	var lastActive string = "5020-04-16 01:19:56 +0530 IST m=+6.330077699"
	for cur.Next(context.Background()) {
...
//Assign a free officer to a case
...
//Check if the case for vehicle number already exists
